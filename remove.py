...
# Read the CSV file
df = pd.read_csv('min5_prof/Nifty 50_agg.csv')
df1 = pd.read_csv('min5_prof/Nifty Bank_agg.csv')
...
sorted_1.to_csv('min5_prof/bank_nifty_top.csv', index=False)
sorted_df.to_csv('min5_prof/Nifty_top50_agg.csv', index=False)