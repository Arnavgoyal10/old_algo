...
def main(symbol, count):
    ...
    ret = pd.read_csv(f'min3/{folder}/{symbol}_params.csv')
    ret1 = pd.read_csv(f'monthly_3min/{folder1}/{symbol}.csv')
    ...
    ret.to_csv(f'min3/{folder1}/{symbol}_trial.csv', index=False)
