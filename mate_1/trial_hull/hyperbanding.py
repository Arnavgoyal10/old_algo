...
import mate_1.trial_hull.refracted_advance as refracted
import csv
from hyperopt import hp, fmin, tpe, Trials
from hyperopt.pyll.base import scope
from datetime import datetime
import threading
import other_indicators.hull_ma as hull_ma
...
def final(name):
    ...
    with open(f"mate_1/trial_hull/{name}_agg.csv", "w", newline='') as csvfile:
